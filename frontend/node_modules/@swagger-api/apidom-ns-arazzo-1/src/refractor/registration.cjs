...
_ArazzoSpec.default.refract = (0, _index.createRefractor)(['visitors', 'document', 'objects', 'ArazzoSpecification', 'fixedFields', 'arazzo']);
_ArazzoSpecification.default.refract = (0, _index.createRefractor)(['visitors', 'document', 'objects', 'ArazzoSpecification', '$visitor']);
