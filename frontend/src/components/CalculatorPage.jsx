...
export default function CalculatorPage({ user, setUser, setCurrentPage, calcQuery, setCalcQuery }) {
  // seed
  ...
  // sync desc when arriving from a new search
  useEffect(() => { if (calcQuery) setDesc(calcQuery); }, [calcQuery]);
