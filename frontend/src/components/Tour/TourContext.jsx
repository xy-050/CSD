...
const allSteps = {
    ...
    calculator: [
        ...
        {
            selector: '[data-tour="price-history-chart"]',
            content:
                'This line chart shows how prices have changed over time for the selected country.',
            mutationObservables: ['[data-tour="price-history-chart"]'],
            resizeObservables: ['[data-tour="price-history-chart"]'],
        },
        {
            selector: '[data-tour="price-distribution-map"]',
            content:
                'This world map compares prices across countries – darker shades mean higher prices.',
            mutationObservables: ['[data-tour="price-distribution-map"]'],
            resizeObservables: ['[data-tour="price-distribution-map"]'],
        },
        {
...
export const tourStyles = {
    ...
    highlightedArea: (base) => ({
        ...base,
        rx: 18,   // horizontal radius
        ry: 18,   // vertical radius
    }),
};
